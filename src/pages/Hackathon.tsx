...
//       <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">Upcoming Hackathons</h2>
//       <ul className="space-y-4">
//         {hackathons.map((hackathon, index) => (
//           <li
//             key={index}
//             className="flex justify-between items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition"
//           >
//             <div>
//               <p className="text-lg font-medium text-gray-800 dark:text-white">{hackathon.name}</p>
//               <p className="text-gray-500 text-sm dark:text-gray-400">
//                 {hackathon.date} • {hackathon.location}
//               </p>
//             </div>
//             <span className="text-gray-600 dark:text-gray-300">{hackathon.participants} Participants</span>
//           </li>
//         ))}
//       </ul>
//     </div>
